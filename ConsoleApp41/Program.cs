...
namespace ConsoleApp41
{
    class Program
    {
        ...
        public class Airplane : Dispatch
        {
            ...
            public override void Message(string temp) => Console.WriteLine($"Aircraft message:{temp}");
        }
        public class Helicopter : Dispatch
        {
            public Helicopter(Mediator mediator) : base(mediator) { }
            public override void Message(string temp) => Console.WriteLine($"Helicopter message::{temp}");
        }
        public class Rocket : Dispatch
        {
            public Rocket(Mediator mediator) : base(mediator) { }
            public override void Message(string temp) => Console.WriteLine($"Missile message:{temp}");
        }
